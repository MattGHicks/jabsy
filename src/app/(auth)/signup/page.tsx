        ...
        <div className="bg-[#141414] border border-[#1e1e1e] rounded-lg p-8">
          <div className="mb-7">
            <h1 className="text-xl font-semibold text-[#f4f4f5] mb-1">
              {pending_invite ? 'Create an account to join' : 'Create your account'}
            </h1>
            <p className="text-sm text-[#71717a]">
              {pending_invite ? 'Sign up to accept your league invite.' : 'Start competing with your crew'}
            </p>
          </div>
          ...
          <form action={signUp} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="confirm_password" className="text-xs font-medium text-[#a1a1aa]">Confirm Password</label>
